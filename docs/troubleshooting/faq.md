...
### Can I run DClaw Meet without Kubernetes?

Yes, for local development:

```bash
cd dclaw-meet/frontend && npm run dev
cd dclaw-meet/backend && uvicorn dclaw_meet.main:app --reload
```
